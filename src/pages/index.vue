...
<template>
  ...
  <div class="container my-24 mx-auto md:px-6">
    ...
    <section class="mb-32">
      <h2 class="mb-16 text-center text-2xl font-bold">Dropper</h2>
      ...
      <div class="mb-16 flex flex-wrap">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
          <h3 class="mb-4 text-2xl font-bold">How to store creativity!</h3>
          ...
          <p class="mb-6 text-sm text-neutral-500 dark:text-neutral-400">
            Published <u>21 august 2023</u> by
            <a href="#!">Jay McAnser</a>
          </p>
          <p class="mb-6 text-neutral-500 dark:text-neutral-300">
            How do we think, create, associate? How does it work? Everybody has their own way, but we all want to keep that moment
            when the brainwacve came.
          </p>
          <p class="text-neutral-500 dark:text-neutral-300">
            Dropper is the notebook, the paper to draw on, the recorder for the sound. Share your work, work together on a project, let
            other users comment on the work you created.<br/>
            But also protect you information, use "bronvermelding"
          </p>
        </div>
      </div>
      ...
      <div class="mb-16 flex flex-wrap lg:flex-row-reverse">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
          ...
          <p class="mb-6 text-sm text-neutral-500 dark:text-neutral-400">
            Published <u>21.08.2023</u> by
            <a href="#!">Jay McAnser</a>
          </p>
          <p class="text-neutral-500 dark:text-neutral-300">
            <router-link to="/user/create" class="text-red-600">Create an account</router-link> or <router-link to="/user/login" class="text-red-600">login</router-link> and share your ideas and
            art
          </p>
        </div>
      </div>
